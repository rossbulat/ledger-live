...
var mapResult = function (_a) {
    var languageInstalled = _a.languageInstalled;
...
var reducer = function (state, e) {
    switch (e.type) {
        ...
        case "devicePermissionRequested":
            return __assign(__assign({}, state), { unresponsive: false, languageInstallationRequested: true, isLoading: false });
        case "languageInstalled":
            return __assign(__assign({}, state), { unresponsive: false, languageInstallationRequested: false, isLoading: false, installingLanguage: false, languageInstalled: true });
        case "progress":
            return __assign(__assign({}, state), { unresponsive: false, languageInstallationRequested: false, isLoading: false, installingLanguage: true, progress: e.progress });
    }
};
var implementations = {
    ...
    event: function (_a) {
        var deviceSubject = _a.deviceSubject, installLanguage = _a.installLanguage, language = _a.language;
        return deviceSubject.pipe((0, operators_1.debounceTime)(1000), (0, operators_1.switchMap)(function (d) { return installLanguage(d, language); }));
    },
    ...
    polling: function (_a) {
        ...
        return new rxjs_1.Observable(function (o) {
            ...
            var DEVICE_POLLING_TIMEOUT = 30000;
            ...
            var initT = setTimeout(function () {
                ...
                device = null;
                (0, logs_1.log)("actions-install-language-event/polling", "device init timeout");
            }, INIT_DEBOUNCE);
            var connectSub;
            var loopT;
            var disconnectT;
            ...
            function loop() {
                ...
                (0, logs_1.log)("actions-install-language-event/polling", "polling loop");
                        ...
                        if (event.type === "error" && event.error) {
                            if (event.error instanceof errors_2.DisconnectedDevice ||
                                ...
                                disconnectT = setTimeout(function () {
                                    ...
                                    device = null;
                                    o.next(event);
                                    (0, logs_1.log)("actions-install-language-event/polling", "device disconnect timeout");
                                }, DISCONNECT_DEBOUNCE);
                            }
                            else {
...
var createAction = function (installLanuageExec) {
    var installLanguage = function (device, language) {
    ...
    var useHook = function (device, language) {
        ...
        (0, react_1.useEffect)(function () {
            ...
            (0, operators_1.tap)(function (e) { return (0, logs_1.log)("actions-install-language-event", e.type, e); }), 
