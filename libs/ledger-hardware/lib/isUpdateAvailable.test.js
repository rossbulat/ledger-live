...
var mock_1 = require("../apps/mock");
describe("isUpdateAvailable tests", function () {
    var scenarios = [
        {
        ...
        },
        {
            ...
            deviceInfo: mock_1.deviceInfo202,
            expectedResult: true,
            outdatedApp: {
                name: "Ethereum",
                version: "1.9.0"
    ...
    scenarios.forEach(function (_a) {
        var name = _a.name, deviceInfo = _a.deviceInfo, outdatedApp = _a.outdatedApp, expectedResult = _a.expectedResult;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, isUpdateAvailable_1["default"])(deviceInfo, outdatedApp)];
                    case 1:
                        result = _a.sent();
...
//# sourceMappingURL=isUpdateAvailable.test.js.map