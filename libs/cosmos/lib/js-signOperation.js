...
var deviceAccess_1 = require("@ledgerhq/common/lib/hw/deviceAccess");
var operation_1 = require("@ledgerhq/common/lib/operation");
var hw_app_cosmos_1 = __importDefault(require("@ledgerhq/hw-app-cosmos"));
var stargate_1 = require("@cosmjs/stargate");
var js_buildTransaction_1 = require("./js-buildTransaction");
var bignumber_js_1 = __importDefault(require("bignumber.js"));
var crypto_1 = require("@cosmjs/crypto");
var aminoTypes = new stargate_1.AminoTypes({ prefix: "cosmos" });
            ...
            function main() {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                hwApp = new hw_app_cosmos_1["default"](transport);
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, Cosmos_1.defaultCosmosAPI.getChainId()];
                            case 2:
                                chainId = _d.sent();
                            ...
                            case 5:
                                ...
                                secp256k1Signature = crypto_1.Secp256k1Signature.fromDer(new Uint8Array(signature)).toFixedLength();
                                return [4 /*yield*/, (0, js_buildTransaction_1.postBuildTransaction)(account, transaction, pubkey, unsignedPayload, secp256k1Signature)];
                            case 6:
                                tx_bytes = _d.sent();
