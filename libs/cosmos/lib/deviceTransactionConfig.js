...
var getSendFields = function (_a) {
    ...
    if (!amount.isZero()) {
        fields.push({
            type: "text",
            label: "Amount",
            value: (0, currencies_1.formatCurrencyUnit)((0, account_1.getAccountUnit)(account), amount, {
                showCode: true,
    ...
    switch (mode) {
        ...
        case "undelegate":
            ...
            fields.push({
                type: "text",
                label: "Amount",
                value: (0, currencies_1.formatCurrencyUnit)((0, account_1.getAccountUnit)(account), validators[0].amount, {
                    showCode: true,
                    disableRounding: true
                })
            });
