        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, js_prepareTransaction_1["default"])(mainAccount, __assign(__assign(__assign({}, (0, js_createTransaction_1["default"])()), transaction), { recipient: (transaction === null || transaction === void 0 ? void 0 : transaction.recipient) || (0, cryptoassets_1.getAbandonSeedAddress)(mainAccount.currency.id), useAllAmount: true }))];
                case 1:
                    t = _b.sent();
                    return [4 /*yield*/, (0, js_getTransactionStatus_1["default"])(mainAccount, t)];
                case 2:
                    s = _b.sent();
                    return [2 /*return*/, s.amount];
            }
        });
    });
};
