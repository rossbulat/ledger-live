            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 4:
                        ...
                        delegations.push({
                            ...
                            amount: d.balance.denom === currency.units[1].code
                                ? new bignumber_js_1["default"](d.balance.amount)
                                : new bignumber_js_1["default"](0),
                            pendingRewards: new bignumber_js_1["default"](0),
                            status: status
                        });
                        _l.label = 5;
                    case 5:
                    ...
                    case 8:
                        ...
                        return [7 /*endfinally*/];
                    case 9: return [4 /*yield*/, (0, network_1["default"])({
                            method: "GET",
                                        ...
                                        if (r.validator_address === d.validatorAddress) {
                                            try {
                                                for (_e = (e_7 = void 0, __values(r.reward)), _f = _e.next(); !_f.done; _f = _e.next()) {
                                                    reward = _f.value;
                                                    d.pendingRewards = d.pendingRewards.plus(new bignumber_js_1["default"](reward.amount).integerValue());
                                                }
                                            }
                                ...
                                try {
                                    for (_c = (e_9 = void 0, __values(r.entries)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                        ...
                                        redelegations.push({
                                            ...
                                            amount: new bignumber_js_1["default"](entry.redelegation_entry.initial_balance),
                                ...
                                try {
                                    for (_c = (e_11 = void 0, __values(u.entries)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                        ...
                                        unbondings.push({
                                            ...
                                            amount: new bignumber_js_1["default"](entry.initial_balance),
        ...
        this.simulate = function (tx_bytes) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        data = (_b.sent()).data;
                        return [2 /*return*/, new bignumber_js_1["default"](((_a = data === null || data === void 0 ? void 0 : data.gas_info) === null || _a === void 0 ? void 0 : _a.gas_used) || 0)];
                    case 2:
                        e_13 = _b.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, (0, operation_1.patchOperationWithHash)(operation, data.tx_response.txhash)];
                    }
                });
            });
        };
...
exports.defaultCosmosAPI = new CosmosAPI();
