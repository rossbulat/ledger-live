...
var osmosisCryptoCurrency = (0, currencies_1.getCryptoCurrencyById)("osmo");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, sdk_2.osmosisAPI.queryTotalSupply(denom)];
            case 1:
                totalSupply = _a.sent();
...
var _getPool = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sdk_2.osmosisAPI.queryPool()];
            case 1:
                pool = _a.sent();
...
var _getDistributionParams = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sdk_2.osmosisAPI.queryDistributionParams()];
            case 1:
                distributionParams = _a.sent();
...
var osmosisValidatorsManager = new CosmosValidatorsManager_1.CosmosValidatorsManager(osmosisCryptoCurrency, {
    endPoint: sdk_1.nodeEndpoint,
    namespace: "osmosis",
...
exports["default"] = osmosisValidatorsManager;
