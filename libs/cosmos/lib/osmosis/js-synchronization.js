...
exports.sync = exports.scanAccounts = void 0;
        ...
        switch (_d.label) {
            case 0:
                ...
                if (address.match(accountPubPrefix)) {
                    ...
                    xpubOrAddress = (0, amino_1.pubkeyToAddress)(pubkey, accountAddressPrefix);
                }
                ...
                return [4 /*yield*/, sdk_1.osmosisAPI.getAccountInfo(xpubOrAddress, currency)];
            case 1:
                ...
                return [4 /*yield*/, sdk_1.osmosisAPI.getOperations(accountId, address, lastOperationDate)];
            case 2:
                newOperations = _d.sent();
                // Merge new operations with the previously synced ones
                operations = (0, jsHelpers_1.mergeOps)(operations, newOperations);
                balance = balances;
...
exports.scanAccounts = (0, jsHelpers_1.makeScanAccounts)({ getAccountShape: getAccountShape, getAddressFn: hw_getAddress_1["default"] });
exports.sync = (0, jsHelpers_1.makeSync)({ getAccountShape: getAccountShape });
