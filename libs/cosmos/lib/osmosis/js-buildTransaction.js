...
var keys_1 = require("@keplr-wallet/proto-types/cosmos/crypto/secp256k1/keys");
var tx_2 = require("@keplr-wallet/proto-types/cosmos/tx/v1beta1/tx");
var tx_3 = require("cosmjs-types/cosmos/tx/v1beta1/tx");
var tx_4 = require("cosmjs-types/cosmos/distribution/v1beta1/tx");
            ...
            case "redelegate":
                if (transaction.sourceValidator &&
                    ...
                    protoMsgs.push({
                        ...
                        value: tx_1.MsgBeginRedelegate.encode({
                            delegatorAddress: account.freshAddress,
                ...
                if (transaction.validators && transaction.validators.length > 0) {
                    ...
                    if (validator && validator.address /*&& transaction.amount.gt(0)*/) {
                        ...
                        protoMsgs.push({
                            ...
                            value: tx_1.MsgUndelegate.encode({
                                delegatorAddress: account.freshAddress,
                                validatorAddress: validator.address,
                                amount: {
                                    denom: account.currency.units[1].code,
            ...
            case "claimReward":
                if (transaction.validators &&
                    ...
                    protoMsgs.push({
                        ...
                        value: tx_4.MsgWithdrawDelegatorReward.encode({
                            delegatorAddress: account.freshAddress,
                            validatorAddress: validator.address
                        }).finish()
                    });
...
var postBuildTransaction = function (signResponse, protoMsgs) { return __awaiter(void 0, void 0, void 0, function () {
    var signed_tx_bytes;
    return __generator(this, function (_a) {
        signed_tx_bytes = tx_2.TxRaw.encode({
            bodyBytes: tx_3.TxBody.encode(tx_3.TxBody.fromPartial({
                messages: protoMsgs,
