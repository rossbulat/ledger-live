...
var preloadedData_1 = require("../../osmosis/preloadedData");
...
var currencyBridge = {
    ...
    preload: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    validators = _a.sent();
                    (0, preloadedData_1.setOsmosisPreloadData)({
    ...
    hydrate: function (data) {
        ...
        (0, preloadedData_1.setOsmosisPreloadData)((0, preloadedData_1.asSafeOsmosisPreloadData)(data));
    },
    scanAccounts: js_synchronization_1.scanAccounts
};
var accountBridge = {
    estimateMaxSpendable: js_estimateMaxSpendable_1["default"],
    createTransaction: js_transaction_1.createTransaction,
    updateTransaction: js_transaction_1.updateTransaction,
    getTransactionStatus: js_getTransactionStatus_1["default"],
    prepareTransaction: js_transaction_1.prepareTransaction,
    sync: js_synchronization_1.sync,
    receive: receive,
    signOperation: js_signOperation_1["default"],
    broadcast: sdk_1.osmosisAPI === null || sdk_1.osmosisAPI === void 0 ? void 0 : sdk_1.osmosisAPI.broadcast
};
exports["default"] = { currencyBridge: currencyBridge, accountBridge: accountBridge };
