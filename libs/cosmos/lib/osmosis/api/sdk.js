...
var indexerEndpoint = (0, env_1.getEnv)("API_OSMOSIS_INDEXER").replace(/\/$/, "");
/**
 ...
 */
var convertTransactionToOperation = function (accountId, type, value, transaction, senders, recipients, extra) {
    ...
    return {
        ...
        accountId: accountId,
        fee: new bignumber_js_1["default"]((0, exports.getMicroOsmoAmount)(transaction.transaction_fee)),
        value: value,
        type: type,
...
exports.convertTransactionToOperation = convertTransactionToOperation;
/**
 * Map transaction to a correct Operation Value (affecting account balance)
 */
function getOperationValue(eventContent, type, fee) {
    var _a, _b;
    var amount;
    switch (type) {
        // Per operation.ts, in "OUT" case, it includes the fees. in "IN" case, it excludes them.
        case "OUT":
            amount = bignumber_js_1["default"].sum((0, exports.getMicroOsmoAmount)((_a = eventContent.sender[0]) === null || _a === void 0 ? void 0 : _a.amounts), fee);
            break;
        case "IN":
            amount = (0, exports.getMicroOsmoAmount)((_b = eventContent.recipient[0]) === null || _b === void 0 ? void 0 : _b.amounts);
            break;
        default:
 ...
 */
var getMicroOsmoAmount = function (amounts) {
    return amounts.reduce(function (result, current) {
        return current.currency === sdk_types_1.OsmosisCurrency
            ? result.plus(new bignumber_js_1["default"](current.numeric))
            : result;
    }, new bignumber_js_1["default"](0));
};
exports.getMicroOsmoAmount = getMicroOsmoAmount;
var OsmosisAPI = /** @class */ (function (_super) {
    __extends(OsmosisAPI, _super);
    function OsmosisAPI() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._defaultEndpoint = exports.nodeEndpoint;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            _a = transactionType;
                            switch (_a) {
                                case sdk_types_1.OsmosisTransactionTypeEnum.Send: return [3 /*break*/, 4];
                                case sdk_types_1.OsmosisTransactionTypeEnum.Delegate: return [3 /*break*/, 6];
                                case sdk_types_1.OsmosisTransactionTypeEnum.Redelegate: return [3 /*break*/, 8];
                                case sdk_types_1.OsmosisTransactionTypeEnum.Undelegate: return [3 /*break*/, 10];
                                case sdk_types_1.OsmosisTransactionTypeEnum.Reward: return [3 /*break*/, 12];
                            }
                            return [3 /*break*/, 14];
        ...
        _this.convertSendTransactionToOperation = function (accountId, address, event, tx, memo) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                ...
                if (!(eventContent.length > 0))
                    return [2 /*return*/];
                sendEvent = eventContent.find(function (event) { return event.type[0] === sdk_types_1.OsmosisTransactionTypeEnum.Send; });
                if (sendEvent == null)
                    return [2 /*return*/];
                ...
                recipients = ((_f = (_e = sendEvent.recipient[0]) === null || _e === void 0 ? void 0 : _e.account) === null || _f === void 0 ? void 0 : _f.id)
                    ...
                    : [];
                fee = new bignumber_js_1["default"]((0, exports.getMicroOsmoAmount)(tx.transaction_fee));
                return [2 /*return*/, (0, exports.convertTransactionToOperation)(accountId, type, getOperationValue(sendEvent, type, fee), tx, senders, recipients, { memo: memo })];
            });
        }); };
        _this.convertDelegateTransactionToOperation = function (accountId, event, tx, memo) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!(eventContent.length > 0))
                    return [2 /*return*/, ops];
                delegateEvent = eventContent.find(function (event) { return event.type[0] === sdk_types_1.OsmosisTransactionTypeEnum.Delegate; });
                    ...
                    validators: [
                        {
                            ...
                            amount: new bignumber_js_1["default"]((0, exports.getMicroOsmoAmount)([delegateEvent.amount.delegate]))
                        },
                    ],
                    autoClaimedRewards: this.calculateAutoClaimedRewards(tx).toString()
                };
                ops.push((0, exports.convertTransactionToOperation)(accountId, type, extra.validators[0].amount, tx, [], [], extra));
                return [2 /*return*/, ops];
            });
        }); };
        _this.calculateAutoClaimedRewards = function (tx) {
            ...
            var SUPPORTED_TYPES = [
                sdk_types_1.OsmosisTransactionTypeEnum.Delegate,
                sdk_types_1.OsmosisTransactionTypeEnum.Redelegate,
                sdk_types_1.OsmosisTransactionTypeEnum.Undelegate,
            ];
            var totalRewardsAmount = new bignumber_js_1["default"](0);
                        ...
                        if (rewardEvent != null &&
                            ...
                            if (rewardEvent.transfers != null) {
                                if (rewardEvent.transfers.reward) {
                                    amount = (0, exports.getMicroOsmoAmount)(rewardEvent.transfers.reward[0].amounts);
        ...
        _this.convertRedelegateTransactionToOperation = function (accountId, event, tx, memo) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!(eventContent.length > 0))
                    return [2 /*return*/, ops];
                redelegEvent = eventContent.find(function (event) { return event.type[0] === sdk_types_1.OsmosisTransactionTypeEnum.Redelegate; });
                    ...
                    validators: [
                        {
                            ...
                            amount: new bignumber_js_1["default"]((0, exports.getMicroOsmoAmount)([redelegEvent.amount.delegate]))
                        },
                    ],
        ...
        _this.convertUndelegateTransactionToOperation = function (accountId, event, tx, memo) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!(eventContent.length > 0))
                    return [2 /*return*/, ops];
                undelegEvent = eventContent.find(function (event) { return event.type[0] === sdk_types_1.OsmosisTransactionTypeEnum.Undelegate; });
                    ...
                    validators: [
                        {
                            ...
                            amount: new bignumber_js_1["default"]((0, exports.getMicroOsmoAmount)([undelegEvent.amount.undelegate]))
                        },
                    ],
                    autoClaimedRewards: this.calculateAutoClaimedRewards(tx).toString()
                };
        ...
        _this.convertRewardTransactionToOperation = function (accountId, tx, memo) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ops = [];
                totalRewardsAmount = new bignumber_js_1["default"](0);
                rewardValidators = [];
                tx.events.forEach(function (event) {
                    if (!Object.prototype.hasOwnProperty.call(event, "sub")) {
                        return ops;
                    ...
                    if (!(eventContent.length > 0))
                        return ops;
                    var rewardEvent = eventContent.find(function (event) { return event.type[0] === sdk_types_1.OsmosisTransactionTypeEnum.Reward; });
                    if (rewardEvent == null)
                        return ops;
                    var amount = new bignumber_js_1["default"](0);
                    if (rewardEvent.transfers != null) {
                ...
                ops.push((0, exports.convertTransactionToOperation)(accountId, type, totalRewardsAmount, tx, [], [], extra));
                return [2 /*return*/, ops];
            });
        }); };
...
exports.osmosisAPI = new OsmosisAPI();
