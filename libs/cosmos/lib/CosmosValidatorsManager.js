...
var getBaseApiUrl = function (currency) {
    if (currency.id === "cosmos_testnet") {
        return (0, env_1.getEnv)("API_COSMOS_TESTNET_BLOCKCHAIN_EXPLORER_API_ENDPOINT");
    }
    else {
        return (0, env_1.getEnv)("API_COSMOS_BLOCKCHAIN_EXPLORER_API_ENDPOINT");
    }
};
var isStargate = function (currency) {
    if (currency.id === "cosmos_testnet") {
        return (0, env_1.getEnv)("API_COSMOS_TESTNET_NODE") == "STARGATE_NODE";
    }
    else {
        return (0, env_1.getEnv)("API_COSMOS_NODE") == "STARGATE_NODE";
    }
};
...
var CosmosValidatorsManager = /** @class */ (function () {
    function CosmosValidatorsManager(currency, options) {
        ...
        this.cacheValidators = (0, cache_1.makeLRUCache)(function (rewardState) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.getRewardsState = (0, cache_1.makeLRUCache)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.getStargateRewardsState = (0, cache_1.makeLRUCache)(function () { return __awaiter(_this, void 0, void 0, function () {
            var inflationUrl, inflationData, currentValueInflation, inflationParametersUrl, inflationParametersData, inflationRateChange, inflationMaxRate, inflationMinRate, targetBondedRatio, assumedTimePerBlock, communityTaxUrl, communityTax, communityPoolCommission, supplyUrl, totalSupplyData, totalSupply, ratioUrl, ratioData, actualBondedRatio, averageDailyFees, averageTimePerBlock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        this.hydrateValidators = function (validators) {
            (0, logs_1.log)("".concat(_this._namespace, "/validators"), "hydrate " + validators.length + " validators");
...
exports.CosmosValidatorsManager = CosmosValidatorsManager;
