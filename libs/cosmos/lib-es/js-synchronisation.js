...
var txToOps = function (info, id, txs) {
    ...
    var _loop_1 = function (tx) {
        ...
        var message = getMainMessage(messages);
        if (message == null) {
            return "continue";
        }
...
export var getAccountShape = function (info) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_d.label) {
            case 0:
                ...
                if (address.match("cosmospub")) {
                    ...
                    xpubOrAddress = pubkeyToAddress(pubkey, "cosmos");
                }
                ...
                return [4 /*yield*/, defaultCosmosAPI.getAccountInfo(xpubOrAddress, currency)];
            case 1:
