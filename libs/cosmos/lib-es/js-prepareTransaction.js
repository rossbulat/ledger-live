...
var getEstimatedFees = function (account, transaction) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                gasQty = new BigNumber(250000);
                gasPrice = new BigNumber(getEnv("COSMOS_GAS_PRICE"));
            ...
            case 1:
                ...
                return [4 /*yield*/, postBuildTransaction(account, transaction, pubkey, unsignedPayload, new Uint8Array(Buffer.from(account.seedIdentifier, "hex")))];
            case 2:
                tx_bytes = _a.sent();
                return [4 /*yield*/, defaultCosmosAPI.simulate(tx_bytes)];
            case 3:
                gasUsed = _a.sent();
                if (gasUsed.gt(0)) {
                    gasQty = gasUsed
...
export var prepareTransaction = function (account, transaction) { return __awaiter(void 0, void 0, void 0, function () {
