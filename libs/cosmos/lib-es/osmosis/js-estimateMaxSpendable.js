...
var estimateMaxSpendable = function (_a) {
    var account = _a.account, parentAccount = _a.parentAccount, mode = _a.mode;
    return __awaiter(void 0, void 0, void 0, function () {
        var a, fees;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    a = getMainAccount(account, parentAccount);
                    return [4 /*yield*/, getEstimatedFees(mode)];
                case 1:
                    fees = _b.sent();
                    return [2 /*return*/, BigNumber.max(0, a.spendableBalance.minus(fees))];
            }
        });
    });
};
