 ...
 * @returns {Transaction}
 */
export var createTransaction = function () { return ({
    family: "osmosis",
    mode: "send",
 ...
 * @param {*} patch
 */
export var updateTransaction = function (t, patch) {
    var _a;
 ...
 * @param {Transaction} t
 */
export var prepareTransaction = function (account, t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                mode = t.mode;
                return [4 /*yield*/, getEstimatedFees(mode)];
            case 1:
                fees = _c.sent();
                return [4 /*yield*/, getEstimatedGas(mode)];
            case 2:
                gas = _c.sent();
                if (!(mode === "send")) return [3 /*break*/, 6];
                _a = t;
                if (!t.useAllAmount) return [3 /*break*/, 4];
                return [4 /*yield*/, estimateMaxSpendable({ account: account, parentAccount: null, mode: mode })];
            case 3:
                _b = _c.sent();
                return [3 /*break*/, 5];
            case 4:
