...
import { asSafeOsmosisPreloadData, setOsmosisPreloadData, } from "../../osmosis/preloadedData";
import getAddress from "../hw-getAddress";
var receive = makeAccountBridgeReceive(getAddress);
...
var currencyBridge = {
    ...
    preload: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, osmosisValidatorsManager.getValidators()];
                case 1:
                    validators = _a.sent();
...
var accountBridge = {
    ...
    broadcast: osmosisAPI === null || osmosisAPI === void 0 ? void 0 : osmosisAPI.broadcast
};
export default { currencyBridge: currencyBridge, accountBridge: accountBridge };
