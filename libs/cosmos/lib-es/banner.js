...
export function getAccountBannerState(account) {
    ...
    var validators = getCurrentCosmosPreloadData().validators;
    var ledgerValidator = validators.find(function (validator) { return validator.validatorAddress === LEDGER_VALIDATOR_ADDRESS; });
