  ...
  describe("synchronization.ts", () => {
    describe("getAccountShape", () => {
          ...
          await synchronization.getAccountShape(
            {
              ...
              initialAccount: {
                ...
                subAccounts: [
                  { ...tokenAccount, operations: [tokenOperations[0]] },
                ],
              },
            },
            {} as any
      ...
      describe("With transactions fetched", () => {
        ...
        it("should return a partial account based on blockHeight", async () => {
          jest
            .spyOn(etherscanAPI, "getLastCoinOperations")
            .mockImplementation(() => Promise.resolve([coinOperations[2]]));
          const operations = [coinOperations[1], coinOperations[0]];
          const accountShape = await synchronization.getAccountShape(
            {
              ...getAccountShapeParameters,
              initialAccount: {
            ...
            subAccounts: [
              {
                ...
                operations: [tokenOperations[1], tokenOperations[0]],
                operationsCount: 2,
              },
            ],
        ...
        beforeAll(() => {
          ...
          jest
            ...
            .mockImplementation((currency, op) =>
              Promise.resolve(
                op.hash === coinOperations[0].hash ? coinOperations[0] : null
              )
            );
        });
    ...
    describe("getOperationStatus", () => {
      it("should not throw on fail", async () => {
        ...
        expect(
          await synchronization.getOperationStatus(currency, coinOperations[0])
        ).toBe(null);
      });
