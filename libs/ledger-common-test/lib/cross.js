...
exports.accountDataToAccount = exports.accountToAccountData = exports.decode = exports.encode = void 0;
// cross helps dealing with cross-project feature like export/import & cross project conversions
var bignumber_js_1 = require("bignumber.js");
var compressjs_1 = __importDefault(require("@ledgerhq/compressjs"));
...
function encode(_a) {
    ...
    return Buffer.from(compressjs_1["default"].Bzip2.compressFile(Buffer.from(JSON.stringify({
        meta: {
...
function decode(bytes) {
    var unsafe = JSON.parse(Buffer.from(compressjs_1["default"].Bzip2.decompressFile(Buffer.from(bytes, "binary"))).toString());
    if (typeof unsafe !== "object" || !unsafe) {
...
function accountToAccountData(_a) {
...
exports.accountToAccountData = accountToAccountData;
...
var accountDataToAccount = function (_a) {
    ...
    var xpubOrAddress = (0, account_1.decodeAccountId)(id).xpubOrAddress; // TODO rename in AccountId xpubOrAddress
    var derivationMode = (0, derivation_1.asDerivationMode)(derivationModeStr);
    ...
    currency.family === "bitcoin" ||
        ...
        freshAddressPath = (0, derivation_1.runDerivationScheme)((0, derivation_1.getDerivationScheme)({
            currency: currency,
            derivationMode: derivationMode
        }), currency, {
            account: index
...
exports.accountDataToAccount = accountDataToAccount;
