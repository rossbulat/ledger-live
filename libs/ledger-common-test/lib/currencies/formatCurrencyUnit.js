...
var BigNumberToLocaleString_1 = require("./BigNumberToLocaleString");
...
function formatCurrencyUnitFragment(unit, value, _options) {
    ...
    (unit.prefixCode ? localeUtility_1.prefixFormat : localeUtility_1.suffixFormat).forEach(function (kind) {
...
function formatCurrencyUnit(unit, value, options) {
