 ...
 * @memberof account
 */
export function groupAccountsOperationsByDay(inputAccounts, _a) {
    ...
    function getNext() {
        ...
        if (bestOp) {
            ...
            var ops = flattenOperationWithInternalsAndNfts(bestOp);
            return {
                ops: ops,
                date: bestOp.date
            };
 ...
 * @memberof account
 */
export function groupAccountOperationsByDay(account, arg) {
