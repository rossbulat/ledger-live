            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, getAddress_1["default"])(getAddressFn)(transport, {
                                currency: currency,
...
function makeAccountBridgeReceive(getAddressFn, _a) {
    ...
    return function (account, _a) {
        ...
        return (0, deviceAccess_1.withDevice)(deviceId)(function (transport) {
            return (0, rxjs_1.from)((0, getAddress_1["default"])(getAddressFn)(transport, arg).then(function (r) {
